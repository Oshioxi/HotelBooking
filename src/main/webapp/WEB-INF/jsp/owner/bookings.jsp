...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            ownerId = HotelBookingAPI.TokenManager.getUserId();
            await loadBookings();
        });
        ...
        async function loadBookings() {
            try {
                ...
                for (const hotel of hotels) {
                    try {
                        const bookings = await HotelBookingAPI.BookingAPI.getByHotel(hotel.id);
                        allBookings = allBookings.concat(bookings);
                    } catch (error) {
                        console.error(`Error loading bookings for hotel ${hotel.id}:`, error);
                    }
                }
        ...
        function displayBookings(bookings) {
            ...
            bookings.forEach(booking => {
                ...
                html += '<tr>' +
                    ...
                    '<td>' + (booking.roomType?.hotel?.name || 'N/A') + '</td>' +
        ...
        async function confirmBooking(id) {
            ...
            try {
                await HotelBookingAPI.BookingAPI.confirm(id);
