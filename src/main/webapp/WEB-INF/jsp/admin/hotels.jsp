...
<body>
    ...
    <main class="main">
        <div class="site-breadcrumb" style="background: url(${pageContext.request.contextPath}/assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Hotel Management</h2>
                    ...
                    <div class="col-lg-9">
                        <div class="user-profile-card">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h4 class="user-profile-card-title">All Hotels</h4>
                                <div>
                                    <select id="statusFilter" class="form-control d-inline-block" style="width: auto;" onchange="filterHotels()">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/admin-hotels.js"></script>
</body>
</html>
