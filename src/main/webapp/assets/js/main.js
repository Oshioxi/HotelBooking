...
(function ($) {
    ...
    // passenger box - simplified total guests selector
    $(".guest-plus-btn").on("click", function (e) {
        e.preventDefault();
        e.stopPropagation();
        var passengerBox = $(this).closest(".passenger-box");
        var spanDisplay = passengerBox.find(".passenger-total-amount");
        var hiddenInput = passengerBox.find(".passenger-total-amount-input");
        var currentValue = parseInt(spanDisplay.text()) || 1;
        var newValue = currentValue + 1;
        spanDisplay.text(newValue);
        hiddenInput.val(newValue);
        passengerBox.find(".guest-minus-btn").removeAttr("disabled");
    });

    $(".guest-minus-btn").on("click", function (e) {
        e.preventDefault();
        e.stopPropagation();
        var passengerBox = $(this).closest(".passenger-box");
        var spanDisplay = passengerBox.find(".passenger-total-amount");
